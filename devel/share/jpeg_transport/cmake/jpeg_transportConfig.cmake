...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'jpeg_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/user/x0221391/ros_ws/src/jpeg_transport/${idir}'.  Ask the maintainer 'x0221391 <x0221391@todo.todo>' to fix it.")
    endif()
